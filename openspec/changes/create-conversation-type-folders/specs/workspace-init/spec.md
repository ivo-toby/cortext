...
- Related to `cli-init` spec (init command behavior)
- Related to conversation-management spec (conversation directory structure)
- Related to registry system (source of folder definitions)
