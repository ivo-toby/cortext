...
- [ ] **Simplify `templates/learning-notes.md`**
...
- [ ] **Simplify `templates/brainstorm.md`**
...
- [ ] **Simplify `templates/debug-session.md`**
...
- [ ] **Simplify `templates/feature-planning.md`**
...
- [ ] **Simplify `templates/meeting-notes.md`**
...
- [ ] **Simplify `templates/review-template.md`**
...
- [ ] **Rewrite `claude_commands/workspace_learn.md`**
...
- [ ] **Rewrite `claude_commands/workspace_brainstorm.md`**
...
- [ ] **Rewrite `claude_commands/workspace_debug.md`**
...
- [ ] **Rewrite `claude_commands/workspace_plan.md`**
...
- [ ] **Rewrite `claude_commands/workspace_meeting.md`**
...
- [ ] **Rewrite `claude_commands/workspace_review.md`**
...
- [ ] **Update `claude_commands/workspace_add.md`**
...
- [ ] **Create `specs/conversation-workflows/spec.md`**
...
- [ ] **Create `specs/template-system/spec.md`**
...
- [ ] **Manual Testing - Brainstorm Workflow**
...
- [ ] **Manual Testing - Other Workflows**
...
- [ ] All 6 templates simplified to <50 lines
- [ ] All 6 slash commands rewritten for conversation-first
- [ ] Slash commands instruct to use Edit tool during conversation
- [ ] Documentation explains new workflow
- [ ] Manual testing shows improved conversation flow
- [ ] No prescriptive field structures remain in templates
- [ ] Instructions emphasize ongoing dialogue over completion
- [ ] Example conversations demonstrate new pattern
