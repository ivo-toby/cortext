...
- Related to conversation type registry (creates initial registry)
- Related to workspace structure (creates directory layout)
- Related to AI tool configuration (configures Claude/Cursor/etc.)
